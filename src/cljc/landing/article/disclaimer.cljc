...
(defn disclaimer-body
  ...
  (case l
    ...
    [:article.text
     ...
     [:p
      [:b "Contact: "]
      "si vous avez des questions à propos de cette clause de non responsabilité, écrivez à info@hephaistox.com"]]
    :en
    [:article.text
     [:h1 "Disclaimer"]
     [:p
     ...
     [:p
      [:b "Contact: "]
      "If you have any questions about this disclaimer, please send your email to info@hephaistox.com"]]))
