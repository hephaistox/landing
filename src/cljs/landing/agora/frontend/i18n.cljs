...
(def ^:private dict
  {"fr"
   {:nav/discover-ki "Connaissances"
    ...
    :admin/sitemap-near-limit "Proche de la limite d'un seul sitemap (50 000) — prévoir l'index découpé (#7)."
   ...
   {:nav/discover-ki "Knowledges"
    ...
    :admin/sitemap-near-limit "Approaching the single-sitemap limit (50,000) — plan the chunked index (#7)."
    :admin/latest "Latest"
    :admin/drop "Drop all"
