...
(def ^:private dict
  {"fr"
   {:nav/discover-ki "Connaissances"
    ...
    :work/find "Trouver une œuvre"
    :work/find-title "Trouver une œuvre"
    :work/create-title "Nouvelle œuvre"
    :work/create-new "Créer"
    :work/find-existing "Rechercher"
    :work/author "Auteur"
    :work/author-ph "Rechercher ou créer un auteur…"
    :work/title "Titre"
    :work/year "Année"
    :work/editor "Éditeur"
    :work/url-ph "URL (lien vers l'œuvre)…"
    :work/new-person "Nouvel auteur"
    :work/add "Ajouter l'œuvre"
    :work/no-results "Aucune œuvre trouvée."
    :card/by "Écrit par"
    :card/in-pub "dans"
    :card/on-date "le"
    ...
    :prefs/rename-alias "Changer de pseudonyme"
    :prefs/alias-save "Enregistrer"
    :prefs/alias-warning
    "Hephaistox fait attention à votre vie privée : vous avez un pseudonyme. Si vous saisissez votre nom réel, vos prises de position lui seront publiquement associées — vous pourrez le remplacer ici à tout moment, mais pas dans les copies déjà faites ailleurs (moteurs de recherche, archives)."
    :prefs/alias-missing "Le pseudonyme ne peut pas être vide."
    :prefs/alias-too-long "Pseudonyme trop long (60 caractères au plus)."
    :prefs/alias-taken "Ce pseudonyme est déjà pris."
    :prefs/alias-failed "Le changement a échoué."
   ...
   {:nav/discover-ki "Knowledges"
    ...
    :work/find "Find a work"
    :work/find-title "Find a work"
    :work/create-title "New work"
    :work/create-new "Create"
    :work/find-existing "Search"
    :work/author "Author"
    :work/author-ph "Search or create an author…"
    :work/title "Title"
    :work/year "Year"
    :work/editor "Editor"
    :work/url-ph "URL (link to the work)…"
    :work/new-person "New author"
    :work/add "Add work"
    :work/no-results "No work found."
    :card/by "Written by"
    :card/in-pub "in"
    :card/on-date "on"
    :date/today "Today"
    ...
    :prefs/rename-alias "Change alias"
    :prefs/alias-save "Save"
    :prefs/alias-warning
    "Hephaistox cares about your privacy, if you enter your real name, your positions will be publicly and durably associated with it."
    :prefs/alias-missing "The alias cannot be empty."
    :prefs/alias-too-long "Alias too long (60 characters at most)."
    :prefs/alias-taken "That alias is already taken."
    :prefs/alias-failed "The change failed."
