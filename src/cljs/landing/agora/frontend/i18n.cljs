...
(def ^:private dict
  {"fr"
   {:nav/discover-ki "Connaissances"
    ...
    :pub/work-here "Travailler dans cette publication"
    :pub/working-here "Vous y travaillez ✓"
    ...
    :source/added-by "Ajouté par"
    :cite/heading "Sources citées"
   ...
   {:nav/discover-ki "Knowledges"
    ...
    :pub/work-here "Work in this publication"
    :pub/working-here "Working here ✓"
    ...
    :source/heading "Source"
    :source/added-by "Added by"
    :cite/heading "Cited sources"
