...
(def ^:private dict
  {"fr"
   {:nav/discover-ki "Connaissances"
    ...
    :home/subtitle "Agora est un graphe public d'étapes de raisonnement contestables. Chaque affirmation remonte aux étapes qui la fondent — et chaque étape peut être contestée pour elle-même."
    ...
    :home/anatomy-lead "Un élément de connaissance, c'est une seule étape de raisonnement : à partir d'entrées tenues pour vraies, une conclusion suit. En voici une."
    ...
    :home/ex-objection "Objection : « rapide » ne devrait-il pas aussi exiger une vitesse soutenue ?"
    :home/problem-title "Déjà eu raison, sans être cru ?"
    :home/problem-body "Le philosophe qu'on écarte, l'ingénieur qu'on ignore, le penseur dont le raisonnement est solide mais ne convainc pas. Avoir raison ne suffit pas quand personne ne peut suivre votre raisonnement. Agora rend chaque étape de votre pensée lisible — et contestable — pour que l'argument parle de lui-même."
    :home/how-title "Comment ça marche"
    :home/how-1-title "Décomposez"
    :home/how-1-body "Découpez votre argument en étapes de raisonnement uniques, chacune défendable séparément."
    :home/how-2-title "Reliez"
    :home/how-2-body "Chaque étape déclare les entrées dont elle dépend et relie ses termes à leur définition."
    :home/how-3-title "Faites contester"
    :home/how-3-body "N'importe qui peut objecter à une étape. Les étapes solides survivent ; les faibles se scindent ou bifurquent."
    ...
    :home/feat-objection-body "Les objections restent attachées pour toujours, avec la réponse de l'auteur."
    :home/feat-versions-title "Des versions immuables"
    :home/feat-versions-body "Rien n'est modifié en place : chaque changement est une nouvelle version traçable."
    ...
    :home/cta-body "Publiez votre première étape. La lecture est libre ; contribuer prend une minute."
   ...
   {:nav/discover-ki "Knowledges"
    ...
    :home/subtitle "Agora is a public graph of challengeable reasoning steps. Every claim traces back to the steps that support it — and every step can be challenged on its own."
    ...
    :home/anatomy-lead "A Knowledge Item is a single reasoning step: given inputs held true, a conclusion follows. Here's one."
    ...
    :home/problem-body "The philosopher who gets waved off, the engineer who gets ignored, the thinker whose reasoning is solid but never lands. Being right isn't enough when no one can follow your reasoning. Agora makes every step of your thinking legible — and challengeable — so the argument speaks for itself."
    ...
    :home/how-2-body "Each step declares the inputs it relies on and links its terms to their definition."
    :home/how-3-title "Invite challenge"
    :home/how-3-body "Anyone can object to a step. Strong steps survive; weak ones get split or forked."
