...
(defn landing-page
  ...
  'anatomy of a claim', the pain it solves, how it works, a feature grid, a live
  example KI from the graph, and a closing call to action. The full browse grid
  lives on the discover page."
  [kis]
  (let [lang @(rf/subscribe [::i18n/lang])]
